...
namespace Project5
{
    ...
    class LockBitMap
    {
        ...
        public void LockBits()
        {
            ...
            {
                Console.WriteLine("The bits could not be locked");
        ...
        public void UnlockBits()
        {
            ...
            {
                Console.WriteLine("The bits could not be unlocked");
                Console.WriteLine(ex.Message);
            }
        }
        ...
        public void SetPixel(int x, int y, Color color)//instead of color - RGB
        {
            // Get color components count
            int cCount = Depth / 8;
